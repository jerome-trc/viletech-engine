...
if(SDL2_SDL2-static_FOUND AND NOT PC_SDL2_FOUND)
    if(WIN32)
        set(_sdl2_static_link_libraries
            user32
            gdi32
            winmm
            imm32
    ...
    elseif(NOT SDL2_SDL2_FOUND)
        set(SDL2_SDL2-static_LINK_LIBRARIES
            ""
            CACHE STRING "Additional libraries to link to SDL2-static.")
        set(SDL2_SDL2-static_LINK_DIRECTORIES
            ""
            CACHE
                PATH
                "Additional directories to search libraries in for SDL2-static."
        )
...
if(SDL2_SDL2_LIBRARY)
    ...
    if(SDL2_SDL2_DLL)
        set_target_properties(
            SDL2::SDL2 PROPERTIES IMPORTED_LOCATION "${SDL2_SDL2_DLL}"
    ...
    if(SDL2_SDL2_LIBRARY_RELEASE)
        ...
        if(SDL2_SDL2_DLL_RELEASE)
            ...
            set_target_properties(
                SDL2::SDL2 PROPERTIES IMPORTED_LOCATION_RELEASE
                                      "${SDL2_SDL2_LIBRARY_RELEASE}")
        endif()
    endif()
    if(SDL2_SDL2_LIBRARY_DEBUG)
        ...
        if(SDL2_SDL2_DLL_DEBUG)
            ...
            set_target_properties(
                SDL2::SDL2 PROPERTIES IMPORTED_LOCATION_DEBUG
                                      "${SDL2_SDL2_LIBRARY_DEBUG}")
        endif()
    endif()
endif()
...
if(SDL2_SDL2-static_FOUND)
    if(NOT SDL2::SDL2-static)
        ...
        set_target_properties(
            ...
            PROPERTIES IMPORTED_LOCATION "${SDL2_SDL2-static_LIBRARY}"
                       ...
                       "${_sdl2_static_compile_options}"
                       INTERFACE_LINK_LIBRARIES "${_sdl2_static_link_libraries}"
                       INTERFACE_LINK_DIRECTORIES
                       "${_sdl2_static_link_directories}"
    ...
    if(SDL2_SDL2-static_LIBRARY_RELEASE)
        set_property(
            ...
            PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
        set_target_properties(
            SDL2::SDL2-static PROPERTIES IMPORTED_LOCATION_RELEASE
                                         "${SDL2_SDL2-static_LIBRARY_RELEASE}")
    endif()
    if(SDL2_SDL2-static_LIBRARY_DEBUG)
        set_property(
            ...
            PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
        set_target_properties(
            SDL2::SDL2-static PROPERTIES IMPORTED_LOCATION_DEBUG
                                         "${SDL2_SDL2-static_LIBRARY_DEBUG}")
    endif()
