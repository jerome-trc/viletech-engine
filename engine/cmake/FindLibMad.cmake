...
find_file(LibMad_DLL_RELEASE NAMES libmad.dll libmad-0.dll)

find_file(LibMad_DLL_DEBUG NAMES libmad.dll libmad-0.dll)
...
if(LibMad_FOUND)
    if(NOT TARGET LibMad::libmad)
        ...
        set_target_properties(
            LibMad::libmad PROPERTIES INTERFACE_INCLUDE_DIRECTORIES
                                      "${LibMad_INCLUDE_DIR}")
    endif()

    if(LibMad_DLL)
        set_target_properties(
            LibMad::libmad PROPERTIES IMPORTED_LOCATION "${LibMad_DLL}"
                                      IMPORTED_IMPLIB "${LibMad_LIBRARY}")
    else()
        set_target_properties(
            LibMad::libmad PROPERTIES IMPORTED_LOCATION "${LibMad_LIBRARY}"
                                      IMPORTED_IMPLIB "${LibMad_LIBRARY}")
    endif()
...
mark_as_advanced(LibMad_INCLUDE_DIR LibMad_DLL LibMad_LIBRARY)
