...
get_flags_from_pkg_config("${_sdl2_mixer_library_type}" "PC_SDL2_MIXER"
                          "_sdl2_mixer")

if(_SDL2_mixer_library_type STREQUAL "STATIC" AND NOT PC_SDL2_MIXER_FOUND)
    set(SDL2_mixer_LINK_LIBRARIES
        ""
        CACHE STRING "Additional libraries to link to SDL2_mixer.")
    set(SDL2_mixer_LINK_DIRECTORIES
        ""
        CACHE PATH
              "Additional directories to search libraries in for SDL2_mixer.")
...
if(SDL2_mixer_FOUND)
    ...
    if(SDL2_mixer_DLL)
        ...
        set_target_properties(
            ${_sdl2_mixer_target_name} PROPERTIES IMPORTED_LOCATION
                                                  "${SDL2_mixer_LIBRARY}")
    endif()
