...
get_flags_from_pkg_config("${_vorbisenc_library_type}" "PC_VORBISENC"
                          "_vorbisenc")
get_flags_from_pkg_config("${_vorbisfile_library_type}" "PC_VORBISFILE"
                          "_vorbisfile")
...
if(Vorbis_Vorbis_FOUND AND NOT TARGET Vorbis::vorbis)
    ...
    if(Vorbis_Vorbis_DLL)
        ...
        set_target_properties(
            Vorbis::vorbis PROPERTIES IMPORTED_LOCATION
                                      "${Vorbis_Vorbis_LIBRARY}")
    endif()
endif()
...
if(Vorbis_Enc_FOUND AND NOT TARGET Vorbis::vorbisenc)
    ...
    if(Vorbis_Enc_DLL)
        ...
        set_target_properties(
            Vorbis::vorbisenc PROPERTIES IMPORTED_LOCATION
                                         "${Vorbis_Enc_LIBRARY}")
    endif()
endif()
...
if(Vorbis_File_FOUND AND NOT TARGET Vorbis::vorbisfile)
    ...
    if(Vorbis_File_DLL)
        ...
        set_target_properties(
            Vorbis::vorbisfile PROPERTIES IMPORTED_LOCATION
                                          "${Vorbis_File_LIBRARY}")
    endif()
endif()
