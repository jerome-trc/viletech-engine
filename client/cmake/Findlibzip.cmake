...
if(_libzip_library_type STREQUAL "STATIC" AND NOT PC_LIBZIP_FOUND)
    set(libzip_LINK_LIBRARIES
        ""
        CACHE STRING "Additional libraries to link to libzip.")
    set(libzip_LINK_DIRECTORIES
        ""
        CACHE PATH "Additional directories to search libraries in for libzip.")
...
if(libzip_FOUND)
    ...
    if(libzip_DLL)
        set_target_properties(
            libzip::zip PROPERTIES IMPORTED_LOCATION "${libzip_DLL}"
                                   IMPORTED_IMPLIB "${libzip_LIBRARY}")
    else()
        set_target_properties(libzip::zip PROPERTIES IMPORTED_LOCATION
                                                     "${libzip_LIBRARY}")
    endif()
endif()

mark_as_advanced(libzip_INCLUDE_DIR libzip_DLL libzip_LIBRARY)
