    ...
    if(NOT TARGET PortMidi::portmidi)
        ...
        set_target_properties(
            ...
            PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${PortMidi_INCLUDE_DIR}"
                       ...
                       "${_portmidi_link_directories}"
                       INTERFACE_LINK_OPTIONS "${_portmidi_link_options}")
    endif()

    if(PortMidi_DLL)
        set_target_properties(
            PortMidi::portmidi PROPERTIES IMPORTED_LOCATION "${PortMidi_DLL}"
                                          IMPORTED_IMPLIB "${PortMidi_LIBRARY}")
    else()
        set_target_properties(
            PortMidi::portmidi PROPERTIES IMPORTED_LOCATION
                                          "${PortMidi_LIBRARY}")
    endif()
...
mark_as_advanced(PortMidi_INCLUDE_DIR PortMidi_DLL PortMidi_LIBRARY)
