...
if(Ogg_FOUND)
    ...
    if(Ogg_DLL)
        set_target_properties(
            Ogg::ogg PROPERTIES IMPORTED_LOCATION "${Ogg_DLL}" IMPORTED_IMPLIB
                                                               "${Ogg_LIBRARY}")
    else()
        set_target_properties(Ogg::ogg PROPERTIES IMPORTED_LOCATION
                                                  "${Ogg_LIBRARY}")
    endif()
...
mark_as_advanced(Ogg_INCLUDE_DIR Ogg_DLL Ogg_LIBRARY)
